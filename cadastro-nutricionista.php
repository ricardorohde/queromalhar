...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	<tr>
		<td><img name="cadastro_nutricionista" src="public/img/cadastro_nutricionista.jpg" width="290" height="25" border="0" id="cadastro_nutricionista" alt="" ></td>
	</tr>
</table>

<!--- Novo Nutricionista --->
<form method="post" action="grava_servico.php" name="form_servico" enctype="multipart/form-data">
<input type="Hidden" name="mensagem" value="4">
<input type="Hidden" name="tipo_servico" value="Nutricionista">
<input type="Hidden" name="assunto" value="Nutricionista Cadastrado">
<table align="center" border="0" cellpadding="0" cellspacing="0"  width="90%">
	...
	<tr>
		<td colspan="2">
			<fieldset>
			<legend class="cadastro_titulo">Novo(a) Nutricionista</legend>
				...
				<table align="center" width="95%" border="0" cellpadding="0" cellspacing="0">
					<tr>
						<td align="center" valign="middle">
							<input src="public/img/bt_enviar.jpg" type="Image" value="Enviar" onclick="Nutricionista(); return false;" width="55" height="20">
							&nbsp;&nbsp;	
