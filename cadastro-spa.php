...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	<tr>
		<td><img name="cadastro_spa" src="public/img/cadastro_spa.jpg" width="290" height="25" border="0" id="cadastro_spa" alt="" ></td>
	</tr>
</table>

<!--- Novo Spa --->
<form method="post" action="grava_servico.php" name="form_servico" enctype="multipart/form-data">
<input type="Hidden" name="mensagem" value="6">
<input type="Hidden" name="tipo_servico" value="Spa">
<input type="Hidden" name="assunto" value="Spa Cadastrado">
<table align="center" border="0" cellpadding="0" cellspacing="0"  width="90%">
	...
	<tr>
		<td colspan="2">
			<fieldset>
			<legend class="cadastro_titulo">Novo Spa</legend>
				...
				<table align="center" width="95%" border="0" cellpadding="0" cellspacing="0">
					<tr>
						<td>
							<fieldset>
							<legend class="cadastro_subtitulo">Dados do Spa</legend>
                    ...
                    <tr>
						<td>							
							...
							<legend class="cadastro_subtitulo">Cadastro Ouro</legend>
								<table align="center" border="0" cellspacing="1" cellpadding="2">
									<tr>
										<td align="right" class="cadastro_formulario">Programação:</td>
										<td><input id="programacao" type="File" name="programacao"></td>
									</tr>
								</table>
							</fieldset>							
						</td>
				...
				<table align="center" width="95%" border="0" cellpadding="0" cellspacing="0">
					<tr>
						<td align="center" valign="middle">
							<input src="public/img/bt_enviar.jpg" type="Image" value="Enviar" onclick="Spa(); return false;" width="55" height="20">
							&nbsp;&nbsp;	
