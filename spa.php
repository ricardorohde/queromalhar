...
<table border="0" cellspacing="2" cellpadding="2" width="100%">
	<tr>
		<td><img name="painel_spa" src="public/img/painel_spa.jpg" width="290" height="25" border="0" id="painel_spa" alt="" /></td>
	</tr>
	<tr>
	...
	<tr>
		<td align="left" class="texto_servico">Programação:&nbsp;<a href="<?php echo $array['srv_programacao']; ?>" target="_blank" class="servico"><?php echo $array['srv_programacao']; ?></a></td>
	</tr>
	<?php } } ?>
	<tr>
		<td align="center"><input src="public/img/bt_voltar.jpg" type="Image" value="Voltar" style="cursor: hand;" onclick="voltarPagina('pesquisa-fisioterapeuta')"></td>	
	</tr>	
</table>
