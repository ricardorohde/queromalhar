...
<table border="0" cellspacing="2" cellpadding="2" width="100%">	
	<tr>
		<td colspan="3"><img name="painel_fisioterapeuta" src="public/img/painel_fisioterapeuta.jpg" width="290" height="25" border="0" id="painel_fisioterapeuta" alt="" ></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td align="left"><input type="text" class="box" maxlength="100" name="fisioterapeuta" size="40" onkeyup="pesquisarFisioterapeuta()"></td>
	</tr>
	</form>
</table>
