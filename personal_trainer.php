...
<table border="0" cellspacing="2" cellpadding="2" width="100%">
	<tr>
		<td><img name="painel_personal" src="public/img/painel_personal.jpg" width="290" height="25" border="0" id="painel_personal" alt="" /></td>
	</tr>
	<tr>
	...
	<tr>
		<td align="left" class="texto_servico">Convênios:&nbsp;<?php echo $array['srv_metodo']; ?></td>
	</tr>
	<?php } } ?>
	<tr>
		<td align="center"><input src="public/img/bt_voltar.jpg" type="Image" value="Voltar" style="cursor: hand;" onclick="voltarPagina('pesquisa-personal-trainer')"></td>	
	</tr>	
</table>
