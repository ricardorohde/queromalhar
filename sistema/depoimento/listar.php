...
$query = $objDepoimento->listarDepoimento10();
?>
            ...
            <legend align="center" class="cadastro_titulo">Depoimento</legend>
                <table align="center" border="0" cellpadding="0" cellspacing="0" width="80%">
                    ...
                    <tr>
                        <td>
                            <fieldset>
                                <legend class="cadastro_titulo">Listar Depoimento</legend>
                                <table align="center" border="0" cellspacing="0" cellpadding="2" width="500">
									<?php $linhas = $objDepoimento->totalRegistros($query);
									if ($linhas != 0) { 		
									while($array = $objDepoimento->mostraRegistros($query)) { ?>
									 <tr>
										<td width="80%" class="mtexto"><?php echo $array['dep_nome']; ?> - <span class="status"><?php echo $array['dep_status']; ?></td>
