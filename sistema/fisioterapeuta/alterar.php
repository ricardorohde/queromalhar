...
$query = $objFisioterapeuta->visualizar($objFisioterapeuta);
$qryFisioterapeuta = $objFisioterapeuta->listarEstado();
?>

<br />

<?php 	while($array = $objFisioterapeuta->mostraRegistros($query)) { ?>
<form method="post" action="grava_alterar.php" name="form_fisioterapeuta" enctype="multipart/form-data">
...
<table align="center" border="0" cellpadding="0" cellspacing="0" width="90%">
	...
	<tr>
		<td colspan="2">
			<fieldset>
				<legend class="cadastro_titulo">Alterar Fisoterapeuta</legend>
				<!--- Dados Responsável --->
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select name="estado" class="box" onchange="RefreshEstado();">
                                                <option value=""></option>
                                                <?php while($aryEstado = $objFisioterapeuta->mostraRegistros($qryFisioterapeuta)) {
                                    ...
                                    <tr>
                                        ...
                                        <td id="divMunicipio">
                                            <select name="municipio" class="box">                                            
                                                <?php while($aryMunicipio = $objFisioterapeuta->mostraRegistros($qryMunicipio)) {
