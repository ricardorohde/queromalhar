...
<table align="center" border="0" cellpadding="0" cellspacing="0" width="90%">
	<tr>
		<td>
            <fieldset>
            <legend align="center" class="cadastro_titulo">Fisoterapeuta</legend>
                <table align="center" border="0" cellpadding="0" cellspacing="0" width="80%">
                    ...
                    <tr>
                        <td>
                            <fieldset>
                                <legend class="cadastro_titulo">Visualizar Fisoterapeuta</legend>
                                <table align="center" border="0" cellspacing="0" cellpadding="2" width="500">
                                    ...
                                    <tr>
								        <td align="right" class="formulario" width="25%">Convênios:</td>
