...
$objFisioterapeuta->setEmpresa(utf8_decode($_POST['nome']));
$query = $objFisioterapeuta->pesquisarFisioterapeuta($objFisioterapeuta);
?>
...
<fieldset>
    ...
    <?php $linhas = $objFisioterapeuta->totalRegistros($query);
    if ($linhas != 0) { 		
