...
<table align="center" border="0" cellpadding="0" cellspacing="0" width="90%">
	<tr>
		<td>
            <fieldset>
            <legend align="center" class="cadastro_titulo">Personal</legend>
                <table align="center" border="0" cellpadding="0" cellspacing="0" width="80%">
                    ...
                    <tr>
                        <td>
                            <fieldset>
                                <legend class="cadastro_titulo">Visualizar Personal</legend>
                                <table align="center" border="0" cellspacing="0" cellpadding="2" width="500">
                                    ...
                                    <tr>
								        <td align="right" class="formulario" width="25%">Método:</td>
										<td class="mtexto">&nbsp;<?php echo $array['srv_metodo'] ?></td>
									</tr>	
