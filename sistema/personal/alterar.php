<?php 
	...
	$query = $objPersonal->visualizar($objPersonal);
	$qryPersonal = $objPersonal->listarEstado();
?>


<?php 	while($array = $objPersonal->mostraRegistros($query)) { ?>
...
<table align="center" border="0" cellpadding="0" cellspacing="0" width="90%">
	...
	<tr>
		<td colspan="2">
			<fieldset>
			<legend class="cadastro_titulo">Alterar Personal Trainer</legend>
				<!--- Dados Responsável --->
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select name="estado" class="box" onchange="RefreshEstado();">
                                                <option value=""></option>
                                                <?php while($aryEstado = $objPersonal->mostraRegistros($qryPersonal)) {
                                    ...
                                    <tr>
                                        ...
                                        <td id="divMunicipio">
                                            <select name="municipio" class="box">                                            
                                                <?php while($aryMunicipio = $objPersonal->mostraRegistros($qryMunicipio)) {
					...
					<tr>
						<td>							
							...
							<legend class="cadastro_subtitulo">Cadastro Ouro</legend>
								<table align="center" border="0" cellspacing="1" cellpadding="2">
									<tr>
										<td align="right" class="formulario">Método:</td>
										<td><textarea id="metodo" class="cadastro_box" cols="50" rows="7" name="metodo"><?php echo $array['srv_metodo']; ?></textarea></td>
									</tr>
								</table>
							</fieldset>							
						</td>
