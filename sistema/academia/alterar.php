...
<table align="center" border="0" cellpadding="0" cellspacing="0" width="90%">
	...
	<tr>
		<td colspan="2">
			<fieldset>
				<legend class="cadastro_titulo">Alterar Academia</legend>				
                <!--- Dados Responsável --->
							...
							<fieldset>
								...
								<table align="center" border="0" cellspacing="1" cellpadding="2">
                                    ...
                                    <tr>
                                        ...
                                        <td id="divMunicipio">
                                            <select name="municipio" class="box">                                            
                                                <?php while($aryMunicipio = $objAcademia->mostraRegistros($qryMunicipio)) {
                                    ...
                                    <tr>
										...
										<td><textarea id="modalidade" class="cadastro_box" cols="48" rows="7" name="modalidade"><?php echo $array['srv_modalidade']; ?></textarea></td>
									</tr>
                                    <tr>
