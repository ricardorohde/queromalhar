            ...
            <legend align="center" class="cadastro_titulo">Dica</legend>
                <table align="center" border="0" cellpadding="0" cellspacing="0" width="80%">
                    ...
                    <tr>
                        <td>
                            <fieldset>
                                <legend class="cadastro_titulo">Listar Dica</legend>
                                <table align="center" border="0" cellspacing="0" cellpadding="2" width="500">
									<?php $linhas = $objDica->totalRegistros($query);
									if ($linhas != 0) { 		
									while($array = $objDica->mostraRegistros($query)) { ?>
									 <tr>
										<td width="80%" class="mtexto"><?php echo $array['dic_fonte']; ?> - <span class="status"><?php echo $array['dic_status']; ?></span></td>
