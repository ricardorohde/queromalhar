...
<table align="center" border="0" cellpadding="0" cellspacing="0" width="90%">
	...
	<tr>
		<td colspan="2">
			<fieldset>
			<legend class="cadastro_titulo">Alterar Spa</legend>
				<!--- Dados Responsável --->
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select name="estado" class="box" onchange="RefreshEstado();">
                                                <option value=""></option>
                                                <?php while($aryEstado = $objSpa->mostraRegistros($qrySpa)) {
                                    ...
                                    <tr>
                                        ...
                                        <td id="divMunicipio">
                                            <select name="municipio" class="box">                                            
                                                <?php while($aryMunicipio = $objSpa->mostraRegistros($qryMunicipio)) {
                    ...
                    <tr>
						<td>							
							...
							<legend class="cadastro_subtitulo">Cadastro Ouro</legend>
								<table align="center" border="0" cellspacing="1" cellpadding="2">
									<tr>
										<td align="right" class="formulario">Programação:</td>
