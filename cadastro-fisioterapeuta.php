...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	<tr>
		<td><img name="cadastro_fisioterapeuta" src="public/img/cadastro_fisioterapeuta.jpg" width="290" height="25" border="0" id="cadastro_fisioterapeuta" alt="" ></td>
	</tr>
</table>

<!--- Novo Fisoterapeuta --->
<form method="post" action="grava_servico.php" name="form_servico" enctype="multipart/form-data">
<input type="Hidden" name="mensagem" value="2">
<input type="Hidden" name="tipo_servico" value="Fisioterapeuta">
<input type="Hidden" name="assunto" value="Fisioterapeuta Cadastrado">
<table align="center" border="0" cellpadding="0" cellspacing="0"  width="90%">
	...
	<tr>
		<td colspan="2">
			<fieldset>
			<legend class="cadastro_titulo">Novo(a) Fisoterapeuta</legend>
				<!--- Dados Responsável --->
				...
				<table align="center" width="95%" border="0" cellpadding="0" cellspacing="0">
					<tr>
						<td>
							<fieldset>
							<legend class="cadastro_subtitulo">Dados do Fisoterapeuta</legend>
					...
					<tr>
						<td>							
							...
							<legend class="cadastro_subtitulo">Cadastro Ouro</legend>
								<table align="center" border="0" cellspacing="1" cellpadding="2">
									<tr>
										<td align="right" class="cadastro_formulario">Convênios:</td>
										<td><textarea id="convenio" class="cadastro_box" cols="50" rows="7" name="convenio"></textarea></td>
									</tr>
								</table>
							</fieldset>
						</td>
				...
				<table align="center" width="95%" border="0" cellpadding="0" cellspacing="0">
					<tr>
						<td align="center" valign="middle">
							<input src="public/img/bt_enviar.jpg" type="Image" value="Enviar" onclick="Fisioterapeuta(); return false;" width="55" height="20">
							&nbsp;&nbsp;	
